...
src_img_path = r'C:\Users\kanno\.gemini\antigravity-ide\brain\b87b4d11-11ef-4be7-91d5-516ee9752a2e\media__1785063940552.jpg'
...
# Save YUTO Recording Studio Feature Article Hero WebP (3:2 landscape)
article_path = os.path.join(articles_dir, 'hero-yuto-feature.webp')
img.save(article_path, 'WEBP', quality=95)
print(f"[OK] Saved YUTO Recording Studio Feature Hero: {article_path} ({w}x{h})")
...
print("[OK] Verified asset-manifest.json: article-hero-yuto is READY!")
