...
src_img_path = r'C:\Users\kanno\.gemini\antigravity-ide\brain\b87b4d11-11ef-4be7-91d5-516ee9752a2e\media__1785058996511.jpg'
...
# 1. Avatar REN WebP (1:1 square)
avatar_path = os.path.join(members_dir, 'avatar-ren.webp')
img.save(avatar_path, 'WEBP', quality=95)
print(f"[OK] Saved Avatar REN: {avatar_path} ({w}x{h})")

# 2. Profile REN WebP (4:5 vertical)
...
print(f"[OK] Saved Profile REN: {profile_path} ({profile_crop.size})")
...
print("[OK] Updated asset-manifest.json: avatar-ren and profile-ren are now READY!")
