...
// 3. Check speaker IDs in articles
...
console.log(`✔ Data validation PASSED! (${members.length} members, ${discography.releases.length} releases, ${discography.recordings.length} recordings, ${articles.length} articles verified)`);
