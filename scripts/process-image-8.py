...
src_img_path = r'C:\Users\kanno\.gemini\antigravity-ide\brain\b87b4d11-11ef-4be7-91d5-516ee9752a2e\media__1785057503761.jpg'
...
# Save Profile LEO WebP (4:5 vertical standing portrait)
profile_path = os.path.join(members_dir, 'profile-leo.webp')
img.save(profile_path, 'WEBP', quality=95)
print(f"[OK] Updated Profile LEO (4:5 portrait): {profile_path} ({w}x{h})")
...
print("[OK] Verified asset-manifest.json: avatar-leo and profile-leo are READY!")
